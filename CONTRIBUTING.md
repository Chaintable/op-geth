...
This repository is a **fork**: upstream [ethereum-optimism/op-geth](https://github.com/ethereum-optimism/op-geth)
...
a general-purpose fork of ethereum-optimism/op-geth.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v1.5.4.mantle.ct.3`); a GitHub Release publishes the versioned images
