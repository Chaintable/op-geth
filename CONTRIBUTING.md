...
This repository is a **fork**: upstream [hemilabs/op-geth](https://github.com/hemilabs/op-geth)
(itself a fork of [ethereum-optimism/op-geth](https://github.com/ethereum-optimism/op-geth)),
plus the [Chaintable pipeline](https://github.com/Chaintable/pipeline) tracer. It
runs the Hemi write node that produces block data for the Chaintable data pipeline.
It is not a general-purpose fork of hemilabs/op-geth.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v1.101503.3-hemi-ct.7`); a GitHub Release publishes the versioned images
